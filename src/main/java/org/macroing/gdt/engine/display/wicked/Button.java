...
/**
 * An abstract base-class for all buttons.
 * 
 * @since 1.0.0
 * @author J&#246;rgen Lundgren
 */
public abstract class Button<T extends Button<T>> extends TextComponent<T> {
	/**
	 ...
	 * 
	 * @param id the ID of this {@code Button} instance
	 * @param wickedDisplay the {@link WickedDisplay} that created this {@code Button} instance
	 * @throws NullPointerException thrown if, and only if, either {@code id} or {@code wickedDisplay} are {@code null}
	 */
	protected Button(final String id, final WickedDisplay wickedDisplay) {
